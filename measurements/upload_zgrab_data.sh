...
# measurements
#mc cp results/zgrab/zgrab_20251214090624_v4.jsonl zgrab-write/catrin/measurements/tool=zgrab/dataset=tcp-anycast/vp=nl-ens/port=top100/year=2025/month=12/day=14/zgrab_20251214090624_v4.jsonl
