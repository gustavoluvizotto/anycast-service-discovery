...
{ time \
    ...
    docker compose run --rm nmap -T4 ${PROTOCOL_VERSION} --script='' --max-retries 3 --min-parallelism 40 --host-timeout 2m -oX "results/nmap/nmap_${TIMESTAMP}_${PROTOCOL_VERSION}.xml" -iL "input/nmap/${INPUT_FILE}" -n -sS
