...
time { \
    docker compose run --rm zgrab multiple -c input/zgrab/zgrab_config.ini -f "input/zgrab/${INPUT_FILE}" -o "results/zgrab/zgrab_${TIMESTAMP}_${PROTOCOL_VERSION}.csv" ${EXTRA_PARAMS}
